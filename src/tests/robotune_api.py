...
import datetime
# # 查询流程
# print(requests.get("http://127.0.0.1:24311/api/services/task/Agv/GetCurrentTaskInfo").json()["result"]["name"])

# requests.post("http://127.0.0.1:24311/api/services/task/DynamicFlow/ClearExistTask")

# # # 查询流程
# if requests.get("http://127.0.0.1:24311/api/services/task/Agv/GetCurrentTaskInfo").json()["result"] == None:
#     print("当前没有任务")
# else:
#     print("当前任务为：", requests.get("http://127.0.0.1:24311/api/services/task/Agv/GetCurrentTaskInfo").json()["result"]["name"])
