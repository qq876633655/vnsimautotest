...
class PySelenium:
    ...
    def __init__(self, browser='Chrome', remoteAddress=None):
        ...
        if remoteAddress is None:
            if browser == "firefox" or browser == "ff":
                ...
                dr = webdriver.Chrome(executable_path=iov_cfg.CHROME_DRIVER)
        ...
        try:
            self.driver = dr
            my_log.info("{0} Start a new browser: {1}, Spend {2} seconds".format(success, browser, time.time() - t1))
        except Exception:
    ...
    def open(self, url):
        ...
        try:
            self.driver.get(url)
            my_log.info("{0} Navigated to {1}, Spend {2} seconds".format(success, url, time.time() - t1))
        except Exception:
            my_log.info("{0} Unable to load {1}, Spend {2} seconds".format(fail, url, time.time() - t1))
            raise
    ...
    def max_window(self):
        ...
        my_log.info("{0} Set browser window maximized, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def set_window(self, wide, high):
        ...
        my_log.info("{0} Set browser window wide: {1},high: {2}, Spend {3} seconds".
                  format(success, wide, high, time.time() - t1))
    ...
    def type(self, css, text):
        ...
        try:
            ...
            el.send_keys(text)
            my_log.info("{0} Typed element: <{1}> content: {2}, Spend {3} seconds".
                      format(success, css, text, time.time() - t1))
        except Exception:
            my_log.info("{0} Unable to type element: <{1}> content: {2}, Spend {3} seconds".
    ...
    def clear_type(self, css, text):
        ...
        try:
            ...
            el.clear()
            el.send_keys(text)
            my_log.info("{0} Clear and type element: <{1}> content: {2}, Spend {3} seconds".
                      format(success, css, text, time.time() - t1))
        except Exception:
            my_log.info("{0} Unable to clear and type element: <{1}> content: {2}, Spend {3} seconds".
                      format(fail, css, text, time.time() - t1))
            raise
    ...
    def click(self, css):
        ...
        try:
            ...
            el = self.get_element(css)
            el.click()
            my_log.info("{0} Clicked element: <{1}>, Spend {2} seconds".format(success, css, time.time() - t1))
        except Exception:
            my_log.info("{0} Unable to click element: <{1}>, Spend {2} seconds".format(fail, css, time.time() - t1))
            raise
    ...
    def right_click(self, css):
        ...
        try:
            ...
            my_log.info("{0} Right click element: <{1}>, Spend {2} seconds".format(success, css, time.time() - t1))
        except Exception:
            my_log.info(
    ...
    def move_to_element(self, css):
        ...
        try:
            ...
            my_log.info("{0} Move to element: <{1}>, Spend {2} seconds".format(success, css, time.time() - t1))
        except Exception:
            my_log.info("{0} unable move to element: <{1}>, Spend {2} seconds".format(fail, css, time.time() - t1))
            raise
    ...
    def double_click(self, css):
        ...
        try:
            ...
            my_log.info("{0} Double click element: <{1}>, Spend {2} seconds".format(success, css, time.time() - t1))
        except Exception:
            my_log.info(
    ...
    def drag_and_drop(self, el_css, ta_css):
        ...
        :param el_css: 方法->需要拖拽的元素
        :param ta_css: 方法->拖拽目的元素
        :return:
        """
        t1 = time.time()
        try:
            ...
            my_log.info("{0} Drag and drop element: <{1}> to element: <{2}>, Spend {3} seconds".
                      format(success, el_css, ta_css, time.time() - t1))
        except Exception:
            my_log.info("{0} Unable to drag and drop element: <{1}> to element: <{2}>, Spend {3} seconds".
                      format(fail, el_css, ta_css, time.time() - t1))
            raise
    ...
    def click_text(self, text):
        ...
        try:
            ...
            my_log.info("{0} Click by text content: {1}, Spend {2} seconds".format(success, text, time.time() - t1))
        except Exception:
            my_log.info(
    ...
    def close(self):
        ...
        t1 = time.time()
        self.driver.close()
        my_log.info("{0} Closed current window, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def quit(self):
        ...
        t1 = time.time()
        self.driver.quit()
        my_log.info("{0} Closed all window and quit the driver, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def F5(self):
        ...
        t1 = time
        self.driver.refresh()
        my_log.info("{0} Refresh the current page, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def js(self, script):
        ...
        try:
            ...
            my_log.info("{0} Unable to execute javascript scripts: {1}, Spend {2} seconds".
                      format(fail, script, time.time() - t1))
            raise
    ...
    def get_attribute(self, css, attribute):
        ...
        try:
            ...
            my_log.info("{0} Get attribute element: <{1}>,attribute: {2}, Spend {3} seconds".format(success,
                                                                                                  css, attribute,
                                                                                                  time.time() - t1))
            return attr
        except Exception:
            my_log.info("{0} Unable to get attribute element: <{1}>,attribute: {2}, Spend {3} seconds".format(fail,
                                                                                                            css,
                                                                                                            attribute,
                                                                                                            time.time() - t1))
            raise
    ...
    def get_title(self):
        ...
        my_log.info("{0} Get current window title, Spend {1} seconds".format(success, time.time() - t1))
        return title
    ...
    def get_url(self):
        ...
        my_log.info("{0} Get current window url, Spend {1} seconds".format(success, time.time() - t1))
        return url
    ...
    def wait(self, secs):
        ...
        my_log.info("{0} Set wait all element display in {1} seconds, Spend {2} seconds".
                  format(success, secs, time.time() - t1))
    ...
    def accept_alert(self):
        ...
        my_log.info("{0} Accept warning box, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def dismiss_alert(self):
        ...
        my_log.info("{0} Dismisses the alert available, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def switch_to_frame_out(self):
        ...
        my_log.info("{0} Switch to frame out, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def open_new_window(self, css):
        ...
        try:
            ...
            my_log.info("{0} Click element: <{1}> open a new window and swich into, Spend {2} seconds".
                      format(success, css, time.time() - t1))
        except Exception:
            my_log.info("{0} Click element: <{1}> open a new window and swich into, Spend {2} seconds".
                      format(fail, css, time.time() - t1))
            raise

    def element_exist(self, css):
        """
        judge element is exist,The return report is true or false.
        ...
        try:
            self.element_wait(css)
            my_log.info("{0} Element: <{1}> is exist, Spend {2} seconds".format(success, css, time.time() - t1))
            return True
        except TimeoutException:
            my_log.info("{0} Element: <{1}> is not exist, Spend {2} seconds".format(fail, css, time.time() - t1))
            return False
    ...
    def take_screenshot(self, file_path=None):
        ...
        t1 = time.time()
        try:
            log_path = os.path.join(os.path.dirname(__file__), '../images/%s' % time.strftime("%Y%m%d"))
            if not os.path.exists(log_path):
                os.mkdir(log_path)
            if not file_path:
                file_path = os.path.join(log_path, "%s.png" % time.strftime("%Y_%m_%d_%H_%M_%S"))
            self.driver.get_screenshot_as_file(file_path)
            my_log.info("{0} Get the current window screenshot,path: {1}, Spend {2} seconds".
                      format(success, file_path, time.time() - t1))
        except Exception:
            my_log.info("{0} Unable to get the current window screenshot,path: {1}, Spend {2} seconds".
                      format(fail, file_path, time.time() - t1))
            raise
    ...
    def into_new_window(self):
        ...
        try:
            ...
            my_log.info("{0} Switch to the new window,new window's url: {1}, Spend {2} seconds".format(success,
                                                                                                     self.driver.current_url,
                                                                                                     time.time() - t1))
        except Exception:
            my_log.info("{0} Unable switch to the new window, Spend {1} seconds".format(fail, time.time() - t1))
            raise
    ...
    def js_click(self, css):
        ...
        try:
            ...
            my_log.info("{0} Unable to use javascript click element: {1}, Spend {2} seconds".format(fail,
                                                                                                  js_str,
                                                                                                  time.time() - t1))
            raise
